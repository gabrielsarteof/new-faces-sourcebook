...
└─ Impulso Corrido [passivo, exige metros de corrida livre declarados antes do salto, Esforço pela fração do percurso comum que os metros representarem]: com espaço para correr antes do salto, o Esforço do golpe lê um degrau acima da classe de golpe desarmado, a classe lâmina curva, ao custo de exigir aquele espaço livre e o Esforço de percorrê-lo. LV5: o mesmo espaço declarado também soma aos metros que a régua de Alcance de Salto ler, na mesma proporção da fração do percurso paga
...
└─ [passivo, sem custo, requer Giro Completo Aprofundado] O giro passa a ler Padrão em vez de Telegrafado: o multiplicador do lado defensivo da conexão que ele concedia ao alvo desaparece por completo, e o alvo deixa de ficar fora de posição por ter esquivado dele, porque não há mais aviso algum para reagir. O golpe conserva o Esforço elevado que Giro Completo já concedia, agora sem nenhum custo em esquiva alheia para pagá-lo. Resolvido contra o par declarado na Tarefa de Âncoras deste documento: o lado defensivo do alvo de baixa evasão volta ao valor base de 27,50, em vez dos 29,15 que o mesmo giro concederia sem a transcendência
...
GIRO COMPLETO, contra alvo de baixa evasão. Par: o praticante de Taekwondo enfrenta o Tanque do exemplo canônico do Núcleo de Combate, lado defensivo da conexão em 27,50 contra o par ofensivo publicado. Sem o giro, o chute comum não toca o Perfil de Evasão. Com Giro Completo declarado: LV4 Aberto, multiplicador 1,25, limiar final 34,38. LV5 Aprofundado largura mínima, elevação 13,00%, limiar final 31,08. LV6 Transcendido largura mínima, elevação 7,60%, limiar final 29,59. LV6 na largura de ápice de ROTAÇÃO, elevação no piso de 6,00%, limiar final 29,15. O mesmo giro contra o Veloz do mesmo exemplo, lado defensivo em 93,75, nunca ultrapassa o teto de 95 em nenhum estado: a régua de Chegada Compacta é invisível ali, porque o teto absorve o efeito inteiro antes dele render qualquer diferença. É consequência declarada e não falha da régua: o giro pesa contra quem já não esquiva bem, e quase nada contra quem já esquiva quase tudo.

QUEDA DE MACHADO, contra guarda alta, medida em regime. Par declarado: um defensor de postura, FOR 15, VEL 15, DES 15, DEF 64, RES 15, do qual saem Guarda máxima 320, recarga de 160 por turno e Absorção 45. O atacante de Taekwondo tem FOR 15, VEL 25 e bônus geral declarado de 140 na perícia, o que põe o Golpe Firme dele em Energia 180. O bônus geral é valor declarado desta âncora e não derivado de construção publicada, escolhido para manter a Energia em 180 e preservar a comparação com a curva que esta âncora media antes do Núcleo de Combate v3.

A unidade de medida é a troca sustentada e não o golpe isolado. Sob barra consumível o primeiro golpe quase nunca diferencia, porque a barra nasce grande por construção, e o que a redução de Guarda compra é antecipação do turno em que ela cede. Um golpe por turno, com a recarga incidindo ao final de cada um:

| Construção | Guarda que o golpe enfrenta | Turno em que a barra cede | Dano acumulado em 5 turnos |
|---|---|---|---|
| sem Queda de Machado | 320 | 9 | 0 |
| LV4 | 227,20 | 4 | 8,99 |
| LV5 | 206,40 | 3 | 15,47 |
| LV6 largura mínima | 184,80 | 2 | 22,29 |
| LV6 largura de ápice | 178,40 | 1 | 24,66 |

Sem o caminho, a barra drena vinte pontos líquidos por turno, cento e oitenta de golpe contra cento e sessenta de recarga, e só cede na nona troca. Cada degrau do caminho antecipa a cedência, e a largura de ápice a produz no primeiro golpe. Depois da primeira Quebra a barra recarrega e volta a ceder todo turno, porque cento e sessenta de recarga não alcançam os cento e oitenta que chegam, e é essa repetição que constrói a diferença acumulada.

A régua diferencia em toda construção, e a diferenciação é de tempo antes de ser de número: as duas colunas caminham juntas e sem empate, do turno nove ao turno um e de zero a quase vinte e cinco. A Quebra deixa de ser evento categórico do topo da curva e passa a ser o regime que todas as construções alcançam, mais cedo conforme a Guarda cede antes, e é essa antecipação que Ruptura formaliza a partir do Aprofundado.

ONDA, contra o teto de Cadência. Par: o Veloz do exemplo canônico, FOR 26, VEL 45, RES 23, PS 816, Golpe da ficha 23,67, Fôlego 11,5, Limiar 46. O golpe desarmado paga Esforço 23,67 × 0,9 = 21,30. Cadência de duas ações extras, pela razão de VEL contra o par. Sem Onda: o primeiro golpe custa 21,30, dentro do Limiar; o segundo, ao degrau ×1,5, eleva o acumulado a 53,26, acima do Limiar de 46, e a rodada fecha em um golpe só. Com Onda: no LV4 largura mínima, economia de 19,66%, o acumulado de dois golpes cai a 42,79, dentro do Limiar; no LV5, economia de 24,07%, cai a 40,44; no LV6 largura mínima, a 38,00; na largura de ápice, a 37,28. Em nenhum estado o terceiro golpe cabe: exigiria economia de 56,8%, muito acima do teto de 30%. O Teto de Esforço por turno, 40% de 816 igual a 326,40, nunca morde nesta âncora: o gasto máximo de uma rodada de três golpes mais uma Esquiva soma 114,00, um terço do teto. O Limiar de recuperação, não o Teto de Esforço, é o muro que Onda governa.
...
1. O Núcleo de Combate não publica a classe do golpe desarmado. Esta perícia herda a classe que `worlds/common/skills/kenpo.md` já declarou por interpolação, Esforço 0,9, `[proposta]`, e não reabre a errata: a pendência é a mesma, já registrada lá, e as duas perícias leem o mesmo valor porque o corpo desarmado é uma grandeza só.
