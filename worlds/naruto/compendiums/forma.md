...
O preço da técnica está inteiro no aprendizado. A mesma ausência de rito que a torna trivial de executar a torna extrema de aprender, porque nada ampara a moldagem e o praticante sustenta a esfera apenas com a própria precisão. O rendimento em mesa pertence a quem refinou o controle, e a reserva maior compra repetição e acesso às variações em lugar de potência por unidade de chakra. Esta é a entrada fundadora da transformação de forma pura no catálogo, e as três seguintes movem um eixo mecânico a partir dela.

O criador canônico não existe nesta linha do tempo. A entrada permanece em Autoria Aberta, e as três variações registradas abaixo dela ficam inacessíveis enquanto o Rasengan não tiver autor.
...
O terceiro databook atribui o porte ao poder da entidade selada do executante canônico e registra a atribuição como crença, não como afirmação. A cautela do original é preservada aqui, e a técnica permanece disponível a qualquer praticante que cumpra os requisitos.
...
O usuário forma uma esfera em cada mão e entrega as duas na mesma ação. Cada esfera reproduz o Rasengan sem alteração de geometria, o que mantém o rendimento por esfera idêntico ao da base e faz a técnica comprar multiplicidade. As duas moldagens simultâneas exigem assistência pela mesma via que o porte elevado exige, por clone ou pelo caminho da segunda janela. O par distribuído alcança dois alvos com a esfera cheia em cada um, e o par convergente sobre um alvo único entrega as duas sem deslocá-lo, porque os torques se cancelam e a energia permanece dentro do corpo em vez de arremessá-lo.

A coincidência de preço com o Ōdama Rasengan é estrutural. Dobrar o volume dentro de uma esfera e repartir o mesmo volume em duas custam igual, porque a RC nominal e o rank das duas entradas coincidem, e a escolha entre elas é de eixo tático.
...
O databook registra a entrada sem letra de rank, ao contrário das vizinhas dela, e a classificação em rank S é atribuída aqui pela escala do efeito. As duas rotulagens que a obra alterna, com e sem o prefixo de modo sábio, ocupam esta entrada única, porque o executante canônico empregava energia natural nas duas e a distinção não se sustenta como mecânica separada.

---

## Índice Rápido por Função Tática

**Abater no contato.** Rasengan, Ōdama Rasengan, Rasenrengan.

**Alcançar mais de um corpo.** Ōdama Rasengan, Rasenrengan, Chō Ōdama Rasengan.

**Disparar sem selo e sem janela.** Rasengan.

**Deslocar o alvo do lugar.** Rasengan, Ōdama Rasengan.

**Decidir por escala.** Chō Ōdama Rasengan.
