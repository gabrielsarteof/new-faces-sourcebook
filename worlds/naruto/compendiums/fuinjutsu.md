...
**Referências.** As camadas de acesso, o estado de autoria, a etiquetagem editorial, a adaptação tecnológica e a fronteira da cópia pelo Sharingan pertencem à Norma de Produção de Compêndios. O portão de rank, a escada de níveis, as inclinações, os caminhos, as réguas de capacidade, de vagas e de inscrição, e a regra de resolução por oposição pertencem à Perícia de Fūinjutsu. Os degraus de exigência de moldagem pertencem à Perícia de Controle de Chakra e ao Manual de Requisitos de Técnica. As faixas de XP por rank, o custo duplo do selamento e o piso de aquisição de kinjutsu pertencem ao Manual de Criação de Jutsus. Os graus de Selamento, Supressão e Dor pertencem ao Sistema de Efeitos de Status.

**Custo duplo declarado.** Toda entrada deste catálogo carrega dois custos de reserva, a preparação paga no ato de inscrever e o acionamento pago no disparo, conforme a seção 7.3 do Manual de Criação de Jutsus. Os valores vivem na ficha individual de cada técnica. O que o corpo da entrada declara é qual dos dois pesa e por quê.

**Escassez canônica declarada.** O domínio possui oito entradas com rank confirmado em fonte primária, e sete delas se concentram nas faixas A e S. A base de E a C é atribuída ou proposta em sua totalidade, porque a obra registra o ofício cotidiano do selador sem jamais rankeá-lo. A distribuição deste catálogo é larga na base por decisão de mesa e estreita no topo por fidelidade à fonte.

**Fronteira do catálogo.** Quatro territórios vizinhos pertencem a outros donos e são citados aqui uma única vez. As Correntes Adamantinas de Selamento e o Repertório do Selamento pertencem ao documento do clã Uzumaki. O Selo do Pássaro Enjaulado pertence ao documento do clã Hyūga. O Selo da Força de Cem e a Liberação do Selo Yin pertencem ao Compêndio de Ninjutsu Médico. O Jarro Purificador de Âmbar, a Cabaça Carmesim, a Corda Dourada e a Espada das Sete Estrelas selam por propriedade do objeto e por gatilho verbal, sem cobrar perícia de quem os empunha, e pertencem ao Documento de Ferramentas Selantes.

**Portão pendente declarado.** Três entradas exigem perícia nomeada em documento publicado e ainda inexistente. Elas trazem o portão declarado na linha de requisitos com a marcação de pendência, publicam preço e permanecem inexecutáveis até a perícia nascer. O preço vale no momento da compra e a ficha individual o corrige dali em diante, sem retroagir sobre quem já pagou.
...
A etiqueta é suprimento tradicional e circula pronta em qualquer posto de abastecimento. O que a perícia acrescenta é autoria: um praticante inscreve as próprias, ajusta o atraso do pavio, arma a condição por toque ou por prazo e prepara volumes que nenhum estoque de missão fornece.
...
É a forma mais barata de tornar um pergaminho inútil nas mãos erradas, e por isso é o padrão de arquivo de clã, de cofre de missão e de correspondência que precisa sobreviver à captura do mensageiro. A vinculação por linhagem é o que faz dele um problema político: um selo de sangue transforma um documento em patrimônio hereditário.
...
O selo carrega quantos documentos a capacidade do praticante comportar e devolve um de cada vez, na ordem que o inscritor declarar. Serve ao correio de guerra, ao arquivo de vila e a toda missão em que a informação vale mais que o carregador dela.
...
A técnica resolve na inscrição um problema que a mesa resolvia em discussão, e o efeito real dela é o esquadrão parar de distribuir carga antes de sair e passar a distribuí-la durante a missão. O selador vira infraestrutura do time sem gastar uma vaga de ficha de ninguém.

O limite é a nomeação. A lista de sacadores é fixada na inscrição, e acrescentar um nome exige reescrever a fórmula do início.
...
A técnica é o degrau em que o armazenamento deixa de ser conveniência e passa a ser função de combate, e é por isso que ela nasce nas mãos de especialistas de arma antes de nascer nas mãos de seladores. O volume liberado lê a capacidade de selo do praticante, e um selador de reserva larga cobre uma clareira inteira com uma única abertura.
...
A técnica eleva a categoria do selo de alvo para área, e faz isso pelo único caminho que o rank D permite, que é preparar o terreno antes. Um esquadrão que escolhe o campo de batalha e chega uma hora mais cedo transforma uma emboscada comum em captura. O inscritor apaga as etiquetas à vontade, o que permite abrir a formação para deixar os próprios companheiros entrarem e saírem.
...
O valor da técnica está na dúvida que ela impõe. Uma etiqueta explosiva escondida na nevasca vale mais que dez etiquetas visíveis, e o adversário gasta ações inteiras filtrando papel enquanto o selador escolhe o momento. A cortina também bloqueia linha de visão para efeitos que a exigem e degrada o rastreio por sinal físico.
...
É o selo mais usado do mundo shinobi e o menos registrado, porque o trabalho dele acontece antes de qualquer combate. Uma reunião de conselho, um interrogatório, uma negociação entre vilas e um plano de deserção passam todos por ele. O portador percebe quando alguém tenta ler o recinto de fora, o que converte a vedação em alarme.
...
A técnica é o primeiro instrumento que um selador iniciante recebe para enfrentar um superior. O praticante que perde a disputa de traço, de capacidade e de velocidade ainda pode vencer a disputa de informação, e uma isca bem posta custa ao adversário a ação mais cara que ele tem, que é a de desarmar com cuidado algo que nunca precisou ser desarmado.

O limite é a leitura única. Um selador que já tenha aberto uma isca do mesmo autor reconhece a mão dele nas seguintes, e a vantagem se esgota contra o mesmo adversário.
...
A técnica muda o que a captura significa. Um pergaminho que se recusa a abrir anuncia que guarda algo, e um pergaminho que abre e mente entrega ao inimigo uma decisão tomada sobre bases erradas. É o instrumento de inteligência mais valioso que este domínio produz, e a vila que o pratica em escala envenena o arquivo de todas as outras.
...
O vaso compartilhado é infraestrutura de campanha antes de ser recurso de combate. Um par de pergaminhos sustenta uma linha de suprimento que nenhuma emboscada intercepta, e sustenta também uma linha de comunicação que nenhum sensor detecta, porque o que atravessa a distância é o conteúdo do selo e nunca um corpo. A perda de um dos dois pergaminhos tranca o conteúdo no outro.
...
A técnica cria um ofício que o mundo shinobi nunca teve, que é o do selador que trabalha para trás. Um cofre violado, um jinchūriki com o selo adulterado e um corpo com cláusula póstuma disparada passam todos a contar quem os tocou. O registro fixado é transportável e admite leitura por terceiro, o que o torna prova diante de um conselho de vila.
...
A elevação é de categoria e não de potência, porque o total liberado permanece igual ao que a carga comportava. O que muda é o que a área passa a valer: um corredor com carga retardada deixa de ser um lugar onde algo aconteceu e passa a ser um lugar onde algo continua acontecendo, e a mesa inteira reorganiza o movimento em volta dele.
...
É o instrumento com que uma vila desarma um prisioneiro sem mutilá-lo e com que uma polícia militar suspende um shinobi sem prendê-lo. O uso institucional é o que define a camada de acesso: a fórmula circula dentro do corpo de segurança de Konoha e sai dele por deserção, por captura de campo ou por autorização que alguém precisou assinar.

O limite é a declaração. O objeto vedado é nomeado na inscrição, e a fórmula ignora qualquer outro que o portador ponha na mão em seguida.
...
O que esta entrada acrescenta ao ofício da captura é o destino do que foi capturado. O fogo selado permanece disponível por tempo indefinido como combustível próprio, e o praticante o reemprega em qualquer técnica de Katon que domine, pagando com o que guardou no lugar de pagar com a própria reserva. Um selador que sobreviva ao Katon de um adversário sai do combate com o arsenal dele no bolso.
...
A técnica pertence à escola de tinta de Konoha e circula apenas dentro dela, porque o desenho precisa nascer da mesma mão que escreve a fórmula. O selador fica absorto no traçado durante a execução inteira e depende de que alguém o cubra, o que faz desta a entrada mais dependente de esquadrão do catálogo.
...
É o selo dos templos e dos arquivos, e a longevidade dele é a característica que importa. Uma muralha inscrita há oitenta anos continua trabalhando com o critério de quem já morreu, e a campanha herda uma porta cuja regra ninguém vivo escolheu. Reescrever a condição exige derrubar a fórmula inteira e começar do traço.
...
Os três executores são satisfeitos por clones das sombras, e é isso que torna a entrada praticável por um único shinobi. A linhagem Sarutobi a mantém como técnica de casa desde o Terceiro, e o acesso a ela sai da vila por mestre, por pergaminho ou pelas rotas que a camada de patrimônio já prevê.
...
A entrada existe no catálogo justamente pela qualidade declarada dela. O Tekkō Fūin custa menos, escreve mais rápido e alcança um patamar de contenção real, e paga por isso com uma costura grosseira que qualquer selador competente lê de longe. A válvula é fixa, o portador convive com pressão constante e a fórmula cede a um desselamento de rank A aplicado por mão hábil, o que faz do jinchūriki de Kumo um alvo cuja libertação é objetivo militar viável.
...
O que a liberação devolve é tudo, incluindo o que ninguém contava. Uma consciência alojada dentro de um selo amaldiçoado sai por ela, um contrato suspenso volta a valer e uma capacidade vedada retorna inteira ao portador. A entrada é o instrumento mais perigoso do catálogo nas mãos de quem não sabe o que está abrindo, e a camada de requisito mecânico existe para que a mesa saiba disso antes de comprá-la.
...
A entrada é a coerção reduzida ao essencial e por isso cabe no rank B: uma condição, um efeito, nenhuma cláusula. O valor tático dela está na latência, porque o inscritor escolhe o momento, e o momento certo em combate vale mais que o grau do efeito. Um selo posto no primeiro turno e acionado no oitavo decide a luta inteira.
...
Esta é a entrada que converte a paridade em duelo. Enquanto a costura falsa existe, a leitura de um selo deixa de ser informação confiável e passa a ser aposta, e dois seladores competentes passam a disputar o que cada um permite que o outro veja antes de disputar o que cada um consegue romper. A camada falsa avisa o inscritor quando é atacada, onde quer que ele esteja.

O limite é a passagem única. A costura falsa absorve um desequilíbrio e se desfaz com ele, e o segundo ataque encontra a fórmula verdadeira exposta.
...
A entrada excede o cerceamento comum em dois pontos. A vedação alcança simultaneamente a fonte selada e o circuito do portador, o que a torna o único efeito do catálogo que fecha duas coisas com uma inscrição. E a fórmula persiste até remoção deliberada por mão de igual patamar, sem prazo, sem desgaste e sem que o portador possa fazer coisa alguma a respeito.
...
O procedimento é violento para quem o recebe. O portador sente a remoção como se o próprio circuito estivesse sendo arrancado, e um jinchūriki desselado por esta técnica passa turnos inteiros sem responder. A dificuldade real está na precisão do golpe, e jōnin experientes falham nela com frequência suficiente para que a técnica seja considerada marca de especialista.
...
A entrada acrescenta à contenção comum o alcance e o preço. A fórmula alcança marcas de patamar acima do que a absolvição sozinha contém, e cobra por isso o sangue do inscritor em volume que o deixa fora de combate, junto de uma dor que costuma derrubar o portador antes do fim do traçado. É o procedimento que uma vila executa em sala fechada com o paciente amarrado.
...
A elevação de alvo para área é o que põe esta entrada acima do cerceamento por contato e é também o que a torna difícil de aplicar. A fórmula cobra que o alvo esteja exatamente dentro do desenho no momento do fechamento, o que transforma a execução em problema de posicionamento e não de perícia. Uma fórmula bem posta no chão de um corredor vale mais que qualquer disputa de traço.
...
É a obra que define Uzushiogakure e a razão pela qual a nação foi destruída. A técnica pertence ao repertório fechado do clã e existe fora dele apenas por concessão direta de quem a possui, e um praticante de outra linhagem que a receba carrega a suspeita política inteira que o sobrenome carregava. O selo aceita ser sobreposto a outro Shishō Fūin, e é dessa sobreposição que nasce o selamento de bijū.
...
A cláusula póstuma comum executa um efeito declarado. Esta executa um selamento pleno, e a diferença entre as duas é a diferença entre punir o assassino e levá-lo junto. A entrada converte a própria morte do praticante no ato mais perigoso da carreira dele, e a mesa que a tem em campo passa a calcular a eliminação de um alvo contando com o que acontece depois que ele cai.
...
A entrada resolve em uma ação de combate o confinamento que o ofício comum resolve em inscrição prévia. O praticante escolhe o lugar em vez de escolher o momento, e o alvo tem uma ação para sair do círculo antes que ele feche. O que fica preso obedece à capacidade de selo do executor, e um Uzumaki de reserva larga prende coisas que nenhum pergaminho comportaria.
...
É o instrumento com que uma vila compra silêncio permanente sem precisar confiar em ninguém, e a instituição que o aplica o aplica em série, sobre unidades inteiras, no dia em que elas entram. A autoridade de acionar permanece com quem inscreveu, e o portador convive com a fórmula pelo resto da vida sem qualquer meio de negociá-la.
...
Esta é a interseção nomeada entre o selamento e a barreira, e por isso é a única entrada do catálogo que cobra as duas perícias de cada executor. A técnica alcança entidades de escala que o cárcere individual recusa, e paga por isso com a exposição total de um esquadrão de quatro pelo tempo que o ritual durar. A amostra de sangue do alvo precisa ser obtida antes, o que empurra a preparação para fora da cena de combate.
...
A entrada resolve o problema mais antigo do ofício, que é a chave existir como coisa roubável. Uma chave viva se esconde sozinha, foge, se recusa e negocia, e a mesa ganha um personagem no lugar de um item de inventário. O inscritor escolhe a quem o contrato responde, e essa escolha costuma valer mais que o próprio selo.

O limite é a mortalidade. A criatura que morre leva a chave com ela, e o selo se torna definitivo para todos, inclusive para quem o escreveu.
...
A sobreposição admite ser imperfeita de propósito, e é aí que a técnica se separa de tudo o mais neste catálogo. O inscritor decide o quanto as duas fórmulas se desencontram, e a fenda que ele deixa determina quanto do chakra selado vaza para o portador ao longo dos anos. Um selo perfeito produz uma prisão, e um selo deixado aberto na medida certa produz um parceiro décadas depois, ao preço do sofrimento de quem carrega a fenda enquanto ela não amadurece. O inscritor pode ainda embutir na fórmula chakra próprio como contingência, que se manifesta uma única vez no momento em que o selo estiver prestes a ceder.
...
O procedimento consome três dias completos com os nove presentes e se estende consideravelmente quando faltam executores. A ordem de extração é obrigatória e a última bijū precisa ser a de nove caudas, sob pena de a estátua se estilhaçar com tudo o que já contém. O jinchūriki não sobrevive à extração em nenhuma circunstância, e essa é a razão pela qual a técnica é conhecida no mundo inteiro sem que quase ninguém a tenha visto.
...
**Requisitos:** Fūinjutsu LV6 · Absoluta · Caminho Cárcere · Senjutsu *(perícia pendente)*
**XP:** 45.500
...
A técnica admite duas configurações declaradas na execução. A primeira ergue dez portais e distribui a contenção entre vários alvos ao mesmo tempo. A segunda concentra tudo em um único portal de escala maior e o traz sobre a cabeça de um alvo só, imobilizando a parte do corpo que decide o combate. A energia natural absorvida é o que sustenta o peso, e a fórmula cede no instante em que a absorção cessa.

O limite é a imobilidade da absorção. O praticante precisa estar em Modo Eremita para erguer os portais e precisa continuar nele para mantê-los de pé.

---

## Categoria Especial: A Linhagem do Hiraishin
...
O que o praticante estiver segurando, tocando ou ligado ao próprio chakra viaja junto, e o volume transportado cobra chakra adicional. Massa suficientemente grande consome tanto que a distância alcançável começa a encurtar, e essa relação entre carga e alcance é o único freio que a técnica possui. A marca de destino sobrevive à morte de quem a inscreveu e continua respondendo a qualquer praticante autorizado a lê-la, e a única remoção registrada no mundo é a que ocorre quando uma bijū é extraída do corpo do portador.

O nome vem do para-raios, e a técnica funciona pela mesma lógica: o relâmpago não escolhe onde cai, ele vai ao ponto que foi preparado para recebê-lo. Um selador que passe uma campanha inteira semeando marcas em kunai, em aliados, em paredes e em inimigos constrói um campo de batalha em que ele já está em todos os lugares antes de a luta começar.
...
O que a entrada acrescenta ao salto é o destino móvel. O Deus do Trovão Voador alcança marcas paradas, e esta o ensina a alcançar uma marca que ainda está no ar, o que converte cada kunai do coldre em um ponto de chegada temporário. A técnica é a base do estilo de combate de quem carrega a linhagem e a razão pela qual um selador com quatro lâminas no cinto ocupa cinco posições ao mesmo tempo.
...
O databook registra esta entrada como taijutsu, e a classificação é exata: o ninjutsu espaço-tempo entrega o corpo ao lugar, e o que resolve o combate é a arma na mão de quem chegou. A técnica é a razão pela qual a marca deixou de ser instrumento de fuga e passou a ser instrumento de execução, e um praticante que consiga marcar o adversário durante a luta o mata a partir de qualquer distância.
...
Esta é a única porta de saída conhecida de um selamento que a obra inteira trata como definitivo, e ela existe porque o clã Uzumaki guardou a máscara em um templo que só responde a um sobrenome quase extinto. O ritual cobra vidas oferecidas ao deus em troca das que serão devolvidas, e a conta é fechada pelo próprio Shinigami sem que o executor a negocie.

O limite é a máscara. O objeto é único, está em um lugar só e não admite cópia, e quem o controla controla o acesso de todo o mundo a esta técnica.
...
A marca é aplicada por mordida no pescoço e reage com a energia natural que o corpo do receptor absorve, multiplicando por dez o chakra disponível e amplificando exponencialmente tudo o que ele já sabia fazer. O primeiro grau espalha as marcas pela pele e libera o poder de forma gradual. O segundo transforma o corpo, e o que se levanta depois não é mais inteiramente humano.

Nove em cada dez receptores morrem na aplicação, e o décimo carrega, junto com o poder, um fragmento da consciência e do chakra de quem o marcou. O uso continuado corrói o julgamento antes de corroer o corpo, e a marca fica mais barulhenta a cada vez que o portador cede a ela. O selo não pertence a quem o carrega em momento algum.

O limite é a autoria. A marca responde ao aplicador enquanto ele viver, e removê-la de vez exige expulsar a consciência alojada, o que só duas coisas neste mundo conseguem fazer.
