...
**Referências.** As camadas de acesso, o estado de autoria, a etiquetagem editorial, a adaptação tecnológica e a fronteira da cópia pelo Sharingan pertencem à Norma de Produção de Compêndios. O portão de rank, os dois eixos de falha, o substrato de natureza, a Marca de Reparo, as Quatro Cláusulas e a fronteira absoluta pertencem à perícia Ninjutsu Médico. Os degraus de exigência de moldagem pertencem à perícia Controle de Chakra. As faixas de XP por rank e o piso de aquisição de kinjutsu pertencem ao Manual de Criação de Jutsus. Os graus de condição pertencem ao Sistema de Efeitos de Status.

**Regra de Conversão** [empréstimo declarado]. A cura por chakra converte Reserva em pontos de vida a câmbio declarado. A forma básica converte à razão de sete décimos e a forma plena, disponível a partir do rank A, converte à razão de um para um. A conversão respeita o Limite de Saída de vinte por cento da Reserva por turno. O câmbio é deliberadamente inferior ao câmbio ofensivo do sistema, porque o papel do médico é sustentar o esquadrão através do combate e não anular o dano que ele recebe. A regra é do domínio e não da Norma, e migra para a perícia na próxima errata.

**Escassez canônica declarada.** O domínio possui duas entradas com rank confirmado em fonte primária. Toda a distribuição restante é atribuída por escala de efeito, e essa ausência de escala canônica fica declarada aqui em vez de ficar implícita.

**Camada Patrimônio de Vila preenchida.** Farmacologia de Guerra pertence a Sunagakure, e é a única entrada de dono coletivo do corpus inteiro.
...
O limite é a potência. Preparações de ervas atuam sobre desconforto, febre e recuperação lenta, e nenhuma delas neutraliza veneno de combate.
...
O limite é a cobrança. A pílula adianta o que o corpo não tem, e ao fim da cena o consumidor recebe um grau de Exaustão por dose tomada. Doses acumuladas na mesma cena somam graus e a conta vence inteira. Não acumula Marca de Reparo.
...
A precisão depende da condição da cena. Fora de Pressão Real o corte alcança ponto vital e resolve. Dentro dela o teto cai, e o resultado que a mão entrega é seccionamento de músculo e tendão, que imobiliza o alvo sem matá-lo.
...
O limite é o alcance da estimativa. A entrada mede prazo e não mede resistência a procedimento, e dizer quanto tempo alguém tem não é o mesmo que dizer o que ele aguenta.
...
O limite é a manutenção e a memória. O alvo desperta no turno seguinte ao fim do contato, lembra de tudo até o instante do apagamento, e sabe exatamente quem encostou nele.
...
É a segunda entrada deste compêndio com registro em fonte primária, e a razão pela qual um hospital de vila é uma instituição e não um depósito de macas.
...
Executada sem as condições, o receptor perde a visão do olho instalado em definitivo e o material se perde junto. O enxerto nasce em rejeição ativa como qualquer outro, e um olho de linhagem instalado em corpo incompatível degrada com uso e cobra do portador um preço contínuo.
...
O procedimento exige a leitura completa do que existia antes, porque a construção precisa corresponder ao que o corpo espera encontrar. Uma prótese mal desenhada funciona pela metade e nunca melhora.
...
O acesso vem por origem em Sunagakure, por formação sob mestre saído de lá, por pergaminho de formulação recuperado, por deserção ou por captura de quem carrega o currículo. A vila trata a doutrina como recurso estratégico e a defende como tal, e um praticante de fora dos muros carrega consigo um motivo permanente para ser procurado.
...
A natureza empregada é Yin e não Yang, e a razão é técnica. Chakra de vitalização aplicado a tecido são não repara nada, porque não há o que reparar, e dispara divisão celular prematura que fere o próprio usuário. Instruir sem vitalizar exige a energia que dá forma sem dar vida, e é por isso que esta é a única entrada de cura do compêndio que um praticante de Yang puro não consegue executar de forma alguma. Ela também não acumula Marca de Reparo, porque nada é acelerado.

A técnica inverte a lógica que sustenta todo o resto do domínio, que repara o que já aconteceu, e trabalha sobre o que ainda não aconteceu. Ninguém deu esse salto neste mundo. A entrada é indisponível na criação de personagem e abre-se a quem cumprir o requisito e concluir em jogo o processo de criação de técnica, e o primeiro que a alcançar torna-se o criador registrado.

O limite é a leitura. Errar o ponto antecipado desperdiça a reserva inteira sem efeito algum, a camada desfaz-se ao absorver, não acumula com outra camada ativa e drena de forma contínua enquanto for mantida.
...
A proibição não vem do que a técnica faz e sim do que ela cobra. Cada divisão forçada consome tempo de vida real do usuário, e o corpo possui um número finito delas. Quem sustenta a regeneração paga com anos que não voltam, e o preço se materializa como redução permanente declarada a cada uso.

É a obra que a quarta cláusula da doutrina nomeia. Quem a domina fica dispensado das três primeiras cláusulas, e passa a ser o único médico do mundo autorizado a permanecer na linha de frente.

O salto conceitual está em parar de tratar a cura como intervenção externa sobre um ferimento e passar a tratá-la como ordem geral dada ao corpo inteiro de uma só vez. Ninguém neste mundo deu esse salto. A entrada é indisponível na criação de personagem em qualquer circunstância, e a conclusão dela destrava a linhagem inteira abaixo.
...
O mecanismo é de selo e não de medicina, e por isso a entrada cobra Fūinjutsu junto da perícia médica. A entrada é indisponível na criação de personagem, e o acúmulo só começa depois que a Regeneração Criadora existir neste mundo.
...
A fronteira absoluta da perícia permanece intacta e esta entrada não a viola, porque não é medicina. Nenhum caminho do domínio alcança o que ela faz, nenhuma transcendência a habilita e nenhum médico a executa duas vezes. Ela existe neste compêndio por ser conhecimento que a profissão guarda, e não por ser um verbo que a profissão possui.

O que a técnica cobra não é chakra, e por isso nenhum acúmulo, reserva ou linhagem substitui o pagamento.

O limite não admite negociação. A troca é integral e definitiva, não existe versão parcial, não existe recuo depois de iniciada e o executante não sobrevive a ela.
