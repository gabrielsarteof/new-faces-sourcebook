---
id: naruto.lineage.kekkei-genkai
title: "Kekkei Genkai — Naturezas Herdadas"
version: 1
layer: scenario
scenario: naruto
type: lineage
...
Kekkei Genkai ("limite do mundo do sangue") são naturezas de chakra que combinam dois ou mais elementos básicos. Só podem ser usadas por quem tem a herança genética correspondente.

## Kekkei Genkai no Sistema
...
## Dados Relacionados
- `src/shared/data/rulesets/naruto/lineages.json` → category: `kekkei-genkai`
