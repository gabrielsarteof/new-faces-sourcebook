...
Portão: Fūinjutsu exige Controle de Chakra em nível não inferior ao próprio menos um, e as técnicas do compêndio leem a régua de exigência de moldagem além do portão desta perícia. [proposta]
...
Quando um mesmo ato exige escrever e conter, entra a inclinação do gargalo. Se o que decide é a magnitude do que se contém, é Confinamento. Se o que decide é a velocidade ou a exatidão do traço, é Fórmula. Se o objeto do problema é um portador vivo e o que o selo altera é o que ele pode fazer, é Imposição.

RESOLUÇÃO POR OPOSIÇÃO

Todo confronto entre praticantes resolve contra o teste registrado na ficha do selo no momento da inscrição, e nenhum efeito desta perícia resolve por dificuldade arbitrada. Margem zero ou acima abre o selo. Falha por menos de 15 permite nova tentativa com outra ação. Falha por 15 ou mais dispara o gatilho.
...
O praticante inscreve fora de combate, dez minutos por selo, sobre papel e superfície preparada. Guarda e saca objeto próprio, e executa o Fūinjutsu: Kai nos selos que ele mesmo escreveu. Reconhece que existe um selo diante de si e a que família ele pertence, sem alcançar a função exata.

Capacidade 20 kg. Uma vaga de selo preparado. O selo de armazenamento custa 15 RC de preparação, 5 RC para guardar em campo e nada para sacar. [proposta nos valores]

NÍVEL 2: INCLINAÇÃO (escolha 1)
Base 24 · Inclinação 8 · teste típico 30 fora e 38 dentro, com INT 6

A inscrição cai para um minuto por selo, e superfície irregular, metal e madeira passam a aceitar a fórmula. Em combate, o praticante aplica uma tag já preparada com ação padrão. Abre selo de armazenamento alheio que não tenha gatilho, e lê a condição de disparo de um selo antes de tocá-lo.

Capacidade 144 kg. Três vagas de selo preparado.

CONFINAMENTO: O que o selo guarda. O praticante trata o receptáculo como espaço real e o conteúdo como carga, prendendo matéria, energia livre e entidade sem vínculo com corpo algum.
└─ Entra no teste quando o objeto do problema é matéria, energia livre ou entidade sem vínculo com o corpo de um portador

IMPOSIÇÃO: O que o selo proíbe. O praticante trata o corpo alheio como suporte de escrita e a capacidade do portador como aquilo que a fórmula governa.
└─ Entra no teste quando o objeto do problema é um portador vivo e o selo opera sobre o que ele pode fazer

FÓRMULA: A escrita em si. O praticante trata o traço como o problema, disputando velocidade, leitura, integridade e permanência antes de disputar o conteúdo.
└─ Entra no teste quando o objeto do problema é a escrita, sua execução, sua leitura, seu gatilho ou sua persistência

NÍVEL 3: COMPETÊNCIA
Base 32 · Inclinação 16 (aprofundada) · teste típico 44 fora e 60 dentro, com INT 12

O praticante inscreve selo simples em combate com ação padrão, e tag preparada aplica com ação menor. A trava de contexto cai aqui: abaixo deste nível ninguém inscreve sob combate por teste algum. Pele viva aceita a fórmula, própria ou de aliado imóvel. A leitura alcança a função exata do selo alheio e percebe adulteração. Selo alheio com gatilho abre, com o desarme feito antes.

Capacidade 360 kg. Seis vagas de selo preparado.
...
capacidade em quilos = teste² ÷ 10

O teste é o de Confinamento com a especialização de Receptáculo quando ela existe, e Base Total somada a INT quando o praticante não possui a inclinação. A maior dimensão do que se guarda é limitada a 3 m no baseline e a 8 m sob Receptáculo.

LV1 teste 14 guarda 20 kg · LV2 teste 38 guarda 144 kg · LV3 teste 60 guarda 360 kg · LV4 com Receptáculo teste 112 guarda 1.254 kg · LV5 com Receptáculo aprofundado teste 138 guarda 1.904 kg · LV6 pleno teste 164 guarda 2.690 kg

O neutro da régua é o LV6 pleno, e o resultado dele é a ordem de grandeza de uma equipe de selamento em campo. Massa acima disso é escala de entidade e exige o caminho Cárcere ou formação coletiva.

VAGAS DE SELO PREPARADO

vagas = ⌊teste ÷ 10⌋

O teste é o de Fórmula pela Inclinação Total. As vagas recarregam entre missões, com o custo de preparação pago na inscrição.

RÉGUA DE INSCRIÇÃO

Cada selo declara ações de referência na ficha: três para selo simples, doze para contenção, quarenta para ritual.

ações reais = max(1, ⌈referência × (1 − √(teste ÷ 205))⌉)

O teste é o de Fórmula com a especialização de Traço quando ela existe.

LV3 baseline teste 60 gasta 2, 6 e 19 ações · LV4 com Traço teste 112 gasta 1, 4 e 11 · LV5 com Traço aprofundado teste 138 gasta 1, 3 e 8 · LV6 pleno teste 164 gasta 1, 2 e 6

Os selos de mão da execução continuam governados pela régua de interface de Controle de Chakra, grandeza distinta com fonte distinta.

═══════════════════════════════════════════════════════════════════

NÍVEL 4: ESPECIALIZAÇÃO (escolha 1 caminho)
Base 40 · Inclinação 20 · Especialização 34 a 46 conforme o grau · INT 18

───────────────────────────────
INCLINAÇÃO CONFINAMENTO
───────────────────────────────

RECEPTÁCULO (grau 2, complexidade 3) — 34
Elevar o que o selo comporta e manter íntegro o que não deveria caber. A especialização deste caminho entra no teste de Confinamento quando o problema é volume, governando a régua de capacidade.
└─ Estase [ativado, ação padrão, 60 RC de preparação e 20 de acionamento]: guarda corpo vivo inerte, inconsciente, sedado ou consentâneo, que não respira, não sangra, não envelhece e sai no estado exato em que entrou. Alvo consciente resiste e pertence a outro caminho. LV5: dois corpos por selo, e ferimento em curso deixa de progredir enquanto selado
└─ Desdobramento [ativado, ação menor, custo zero]: saca de até três selos no mesmo ato, com o conteúdo emergindo em movimento na direção declarada. LV5: sem limite de selos no ato, e o saque acontece como ação livre uma vez por turno

APREENSÃO (grau 3, complexidade 4) — 38
Retirar de campo um efeito ativo, prendendo a técnica em vez do corpo que a lançou.
└─ Captura de Técnica [reação, 25% da RC nominal da técnica capturada, mínimo 40 RC]: sela técnica em andamento dentro de 5 m, com a fórmula previamente inscrita no pergaminho. Captura toda técnica cuja RC nominal não exceda o teste multiplicado por seis, 696 no LV4 e 852 no LV5. Propriedade especial do efeito não protege contra a captura. LV5: alcance de 15 m e uma segunda reação por turno
└─ Devolução [ativado, ação padrão, 10% da RC nominal]: libera o que foi capturado na direção declarada, com dano e riders lidos do registro original da técnica. LV5: libera em parcelas, dividindo a RC nominal entre disparos

CÁRCERE (grau 4, complexidade 5) — 42
Converter um receptáculo em prisão sustentada, com vazamento sob controle do inscritor.
└─ Prisão de Entidade [ritual, 400 RC do executor principal, formação de quatro dividindo o custo]: sela entidade de chakra hostil, invocação, construto ou massa livre, em objeto ou corpo. Resolve por oposição entre o teste e a RC da entidade dividida por dez, e a falha consome a RC gasta com a entidade permanecendo livre. Massa em escala de bijū excede este caminho e exige o Repertório do Selamento do clã Uzumaki. LV5: dispensa a formação em alvo de porte menor
└─ Válvula [passivo, declarado na inscrição]: define quanto do chakra selado o portador drena por turno, entre zero e 10% da RC da entidade, com a alteração exigindo nova inscrição. LV5: ajuste em cena com ação padrão e contato
└─ Chave [ativado, 100 RC de preparação]: produz registro externo que afrouxa ou reaperta o selo à distância de contato, e sem ele nem o inscritor reabre o que fechou. LV5: a chave permite o fechamento de emergência sem a presença do portador

───────────────────────────────
INCLINAÇÃO IMPOSIÇÃO
───────────────────────────────
...
Escrever no corpo alheio uma condição que o pune sem a presença do inscritor.
└─ Cláusula [ritual, 200 RC, alvo imóvel, capturado ou consentâneo]: declara na inscrição uma condição verificável, revelar informação nomeada, atacar pessoa nomeada, cruzar um perímetro ou tentar remover o selo. Ao disparar, aplica Dor de grau lido da margem entre o teste do inscritor e a VONTADE do portador. Ativação também por selo de mão de quem detém a autoridade, dentro de 30 m. LV5: duas condições por selo, e a autoridade se estende a terceiro nomeado
└─ Grilhão [ativado, ação padrão, contato, 70 RC]: trava o deslocamento do portador, que responde pela metade do movimento declarado, com a ruptura exigindo teste de FOR contra o teste do inscritor, uma tentativa por turno. LV5: imobilização plena, e a ruptura passa a exigir dano ao próprio membro selado
└─ Cláusula Póstuma [passivo, declarado na inscrição, 150 RC adicionais]: na morte do portador o selo executa um último efeito declarado, inutilizar um órgão ou dōjutsu, apagar a fórmula de qualquer registro, ou detonar o corpo. Dispensa o inscritor vivo. LV5: dispara também por captura declarada

ABSOLVIÇÃO (grau 5, complexidade 3) — 46
Subordinar à vontade do portador uma marca que já habita o corpo dele.
└─ Contenção do Mal [ritual, 150 RC, portador em repouso]: uma marca hostil hospedada passa a depender da vontade do portador para operar. O limiar de contenção é o teste do inscritor dividido por dois, 62 no LV4 e 75 no LV5, e o portador o sustenta com teste de VONTADE sempre que a marca pressiona, mantendo-a inerte enquanto vence. Marca de poder inferior ao limiar fica suprimida sem exigir teste. LV5: contém manifestação forçada de kekkei genkai, e a derrota em um teste abre a marca por uma cena sem anular a contenção
└─ Reforço [ativado, ação completa, 100 RC, contato]: reaperta selo de contenção existente sem reinscrevê-lo, devolvendo a válvula ao valor da ficha original e recuperando integridade perdida por desgaste ou pressão interna. LV5: reforça durante manifestação em curso, contra oposição da entidade contida

───────────────────────────────
INCLINAÇÃO FÓRMULA
───────────────────────────────

TRAÇO (grau 2, complexidade 3) — 34
Escrever no tempo que o combate concede. A especialização deste caminho entra no teste de Fórmula quando o problema é velocidade de execução, governando a régua de inscrição.
└─ Traço Vivo [passivo]: inscreve com chakra direto, sem pincel nem tinta, sobre qualquer superfície, incluindo pele hostil alcançada por toque, com uma única mão. LV5: inscreve em movimento pleno e sobre superfície que se move
└─ Fórmula Parcial [ativado, ação menor, custo zero]: deixa um selo incompleto pré-armado que fecha depois com uma única ação menor, ocupando uma vaga. LV5: três parciais simultâneos, com o fechamento em ação livre

EXEGESE (grau 3, complexidade 4) — 38
Ler, adulterar e desfazer a fórmula de outro.
...
└─ Gatilho [passivo, declarado na inscrição]: condição de disparo por toque, proximidade em metros declarados, abertura, sangue, palavra ou prazo, com três selos armados ao mesmo tempo. Detectar exige Exegese oposta ao teste do inscritor. LV5: condições compostas e reconhecimento de indivíduo nomeado
└─ Carga [ativado, preparação, RC nominal da técnica paga na inscrição]: guarda uma técnica própria dentro do selo, que a executa sem executor quando dispara, limitada a RC nominal igual ao teste multiplicado por quatro, 464 no LV4 e 568 no LV5. LV5: dois disparos por selo

ÂNCORA (grau 4, complexidade 4) — 42
Deixar no mundo uma marca permanente que outra técnica leia depois.
...
NÍVEL 5: MAESTRIA
Base 45 · Inclinação 22 · Especialização 45 a 58 (aprofundada) · INT 26
...
└─ Válvula LV6: admite ajuste remoto pela chave
...
└─ Grilhão LV6: imobiliza sem teste de ruptura
└─ Cláusula Póstuma LV6: dispara também por deserção declarada

Receptáculo e Apreensão permanecem sem transcendência dedicada por pendência declarada: os efeitos dos dois leem teste e crescem pela coluna transcendida, e nenhuma revogação com âncora canônica limpa emergiu da auditoria.

ARQUÉTIPOS DE ÁPICE: o carcereiro de Uzushio é Prisão sem Chave sobre Cárcere e Receptáculo, o homem que guarda o que nenhuma nação consegue reaver. O relâmpago amarelo é Trovão Guia sobre Âncora e Traço, com o salto vindo do compêndio. O guardião de clã é Jugo sobre Silêncio, e contém a maldição de uma casa inteira ao preço político que isso cobra.
...
O clã Uzumaki paga 30% a menos de XP em toda esta perícia, e o Repertório do Selamento abre a ele um caminho fechado aos demais.

═══════════════════════════════════════════════════════════════════

FUNDAMENTO CANÔNICO

Canon: a definição do domínio, selar objetos, seres vivos e chakra dentro de outro objeto, mais a restrição de movimento e o desselamento; o Fūinjutsu: Kai como comando de liberação (Boruto cap. 23); o desequilíbrio de selo ímpar sobre selo par (cap. 91); o bloqueio do fluxo de chakra alheio e a dificuldade de usar o próprio sob o selo (cap. 91); a remoção de selo por praticante superior e o reconhecimento da autoria pela grosseria do traço; Uzushiogakure destruída pelo medo do selamento (cap. 500); a captura de técnica em curso pelo Fūka Hōin, com a propriedade especial das chamas negras não protegendo o efeito; o selamento de alvo em corpo ou objeto pelo Shishō Fūin; a fenda deixada de propósito na costura de dois selos e o registro externo que a manipula; o Fūja Hōin e sua dependência declarada da vontade do portador; o Keiyaku Fūin e a resistência do laço voluntário; o Selo do Pássaro Enjaulado, com ativação remota por selo de mão e execução póstuma sobre o dōjutsu; o Selo Reverso dos Quatro Símbolos disparado pela morte do inscritor; o jutsu-shiki como marca permanente aplicada por contato breve, com remoção registrada como evento raríssimo; a vinculação de um segundo praticante à rede de marcas alheia; o Hiraishin: Guiding Thunder reemitindo o ataque recebido; o selo de Isshiki que mata o conteúdo se aberto por outro e cede apenas a ninjutsu espaço-tempo; o selo de sangue como condição de abertura; e a união de barreira com selamento nomeada Fūin Kekkai.

Atributo: a atribuição do selamento ao eixo de Yin, registrada sem gerar requisito mecânico; a supressão coletiva de bijū em formação; a instituição de um selo de clã sobre uma linhagem inteira como prática política.

Cânone fraco declarado: o teto numérico de massa selável, ausente do material de origem em qualquer forma quantificada.

Decisão de sistema declarada: a fronteira com Controle de Chakra, chakra próprio guardado por moldagem e chakra alheio tomado por selo. A fronteira com a Liberação de Yin, criação do vazio contra escrita sobre o que existe. A barreira mantida fora do domínio, com a interseção nascendo como técnica de compêndio.

Fontes descartadas com registro: fóruns de sistemas de RPG derivados, agregadores editoriais, blogs de fã e wikis de fanon. Nenhum número desta perícia veio deles.
...
Estrutura e valores de camada leem o Núcleo de Perícias v2. Procedimento segue o Manual de Criação de Perícias v7. Custos leem o Manual de Economia de XP. Os dois custos de todo selo leem o Manual de Criação de Jutsus v2, seção 7.3.
