...
Estrutura e valores de camada leem o Núcleo de Perícias v2.2. Procedimento segue o Manual de Criação de Perícias v7.2. Custos leem o Manual de Economia de XP v2.4, seção 6.1. A régua de saturação consome o teste publicado na perícia de Controle de Chakra v3.2, e a condição Petrificação pertence ao Sistema de Efeitos de Status v2.2, que admite esta perícia como fonte de processo interno. A aceitação pelo chefe de espécie e os marcos de relação leem o Documento de Invocação, e a travessia até a terra lê a perícia de Passagem v1.1. O degrau de método que abre porta fechada lê o Manual Global de Treinamento. As técnicas nomeadas vivem no Compêndio de Senjutsu.
