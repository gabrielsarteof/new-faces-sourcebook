...
PERÍCIA DE SENJUTSU
仙術 · O ofício da terceira energia

O Senjutsu é a arte de colher a energia que corre fora do corpo e misturá-la ao chakra próprio. O praticante toma do mundo a energia que não é física nem espiritual e existe independente de quem a recebe, e a soma às duas que já carrega. A mistura em proporção exata produz o chakra de senjutsu e ergue o Modo Sábio. A mistura em proporção errada anima o corpo e o converte em pedra, e é por isso que a esmagadora maioria dos que tentam morre no primeiro esforço sério.
...
Regente RES. Categoria Chakra, multiplicador 1,4. Camada subclasse, sobre o portão de Controle de Chakra. O praticante opera energia bruta, colhendo, retendo e misturando sem converter chakra em outra natureza, e a conversão que define a categoria Ninjutsu não ocorre em nenhum caminho desta perícia.
...
O portão soma a Base Total ao atributo regente e destrava a faixa de rank que o praticante executa no Compêndio de Senjutsu.
...
teste = Base Total + RES + inclinação, se a situação pertence a ela + especialização, se o verbo resolve o problema

Uma inclinação e uma especialização por teste, no máximo.

RESOLUÇÃO

A colheita em si é automática e não rola. O que rola é a resistência de quem sofre um verbo desta perícia, por teste oposto, e a Petrificação da saturação, que se instala sem teste porque a decisão de ultrapassar o teto já foi o teste. Nenhum efeito desta perícia resolve por dificuldade arbitrada.
...
Base 24 · Inclinação 8 · teste típico 30 fora e 38 dentro, com RES 6 · rank D

Acúmulo de 20, teto de 300, dreno de 21, reforço de 5. O catalisador entra em uso, e o praticante o declara na abertura da absorção: ele dobra a taxa de acúmulo e reduz o teto seguro em um quarto no mesmo ato.

COLHEITA: como a energia entra. O praticante trata o mundo como fonte, e o problema é obter volume, obtê-lo rápido e guardá-lo sem que o corpo ceda.
└─ Entra no teste quando a cena tem energia natural disponível em densidade utilizável

COMUNHÃO: o que corre entre o praticante e o que não é ele. A colheita deixa de ser ato solitário e passa a circular entre corpos ligados.
└─ Entra no teste quando há parceiro ligado pelo pacto, praticante aliado do mesmo domínio ou terra de densidade viva

INVESTIDURA: o que o corpo faz com a energia recebida. A energia veste o praticante e o corpo dele passa a operar em outra escala.
└─ Entra no teste quando a resistência do problema é física, resolvida por massa, impacto ou vigor

CONDUÇÃO: o que a obra faz com a energia conduzida. A energia atravessa a técnica e muda o que ela alcança.
└─ Entra no teste quando o obstáculo é feito de chakra

NÍVEL 3: COMPETÊNCIA
Base 32 · Inclinação 16 · teste típico 44 fora e 60 dentro, com RES 12 · rank C

Acúmulo de 29, teto de 440, dreno de 19, reforço de 7. O praticante lê a própria saturação e conhece o valor exato de REN acumulada antes de cruzar o teto, o que converte o risco de acidente em risco de decisão. A entrada parcial torna-se possível, com o modo erguido sobre pool incompleto e sem penalidade de instabilidade.

NÍVEL 4: ESPECIALIZAÇÃO (escolha 1 caminho)
Base 40 · Inclinação 20 · Especialização 30 a 42 · teste típico 58 fora, 78 dentro e 108 a 120 no caminho, com RES 18 · rank B

NÍVEL 5: MAESTRIA
Base 45 · Inclinação 22 · Especialização 40 a 54 · teste típico 71 fora, 93 dentro e 133 a 147 no caminho, com RES 26 · rank A

NÍVEL 6: TRANSCENDÊNCIA (escolha 1)
Base 50 · Inclinação 25 · Especialização 50 a 65 transcendida · RES 34 · rank S
Requisito: todos os caminhos possuídos no estado aprofundado

Testes plenos no LV6 com largura mínima: grau 1 alcança 159, grau 2 alcança 164, grau 3 alcança 169, grau 4 alcança 174. Com a inclinação inteira possuída, a largura de ápice entrega 196 em Colheita, 180 em Comunhão, 183 em Investidura e 172 em Condução, lidos pela especialização transcendida do caminho que cada efeito declarar.

═══════════════════════════════════════════════════════════════════
INCLINAÇÃO COLHEITA
═══════════════════════════════════════════════════════════════════

QUIETUDE (grau 2, complexidade 3) — 34
Obter volume no ritmo em que a cena permite. A especialização deste caminho governa a régua de acúmulo em ambiente vivo.
└─ Colheita Funda [passivo, sem custo]: a taxa lê este caminho, com 74 de REN por turno contra os 38 de quem não o possui. LV5: 92 por turno
└─ Retirada Limpa [reação, sem custo]: interrompe a absorção e age no mesmo turno sem perder o acumulado, revogando a perda de metade que a interrupção forçada impõe. LV5: cancela também a exposição do turno em que foi usada

CATALISADOR (grau 4, complexidade 3) — 42
Alargar o vaso que recebe. A especialização deste caminho governa a régua de teto de REN.
└─ Vaso Alargado [passivo, sem custo]: o teto lê este caminho, com 1.200 contra os 580 de quem não o possui. LV5: 1.470, e o teto passa a valer também para a REN guardada entre cenas
└─ Óleo Domado [ativado, ação menor, sem custo em REN]: o catalisador dobra a taxa sem encolher o teto seguro. LV5: alcança um aliado em contato

VEIO (grau 3, complexidade 2) — 38
Colher onde não há o que colher. A especialização deste caminho governa a régua de acúmulo em ambiente pobre.
└─ Fio de Água na Pedra [passivo, sem custo]: campo arrasado, interior selado e cidade de pedra entregam 38 por turno, contra os 9 de quem não o possui. LV5: 47 por turno, e nenhum ambiente do mundo material fica em zero

DELEGAÇÃO (grau 3, complexidade 4) — 38
Colher por corpo que não é o próprio, e guardar o que sobrou.
└─ Corpo Interposto [ativado, ação padrão, 60 RC por corpo]: um clone colhe em imobilidade e devolve a REN ao original quando desfeito, com dois corpos simultâneos. LV5: quatro corpos, e a devolução ocorre à distância de campo visual
└─ Estoque Guardado [passivo, sem custo]: a REN persiste entre cenas em duas vagas, e o modo entra pronto no primeiro turno. LV5: quatro vagas, e o estoque sobrevive a um descanso longo

SUSTENTO (grau 2, complexidade 3) — 34
Gastar devagar o que foi colhido. A especialização deste caminho governa a régua de dreno de sustentação.
└─ Chama Baixa [passivo, sem custo]: o dreno lê este caminho, com 11 por turno contra os 17 de quem não o possui. LV5: 7 por turno, o que converte o teto em cento e um turnos de modo sustentado
└─ Fundo de Reserva [passivo, sem custo]: o pool nunca cai abaixo de 40, e o modo se apaga em vez de colapsar, dispensando a Exaustão do esgotamento seco. LV5: piso de 80, e o reacendimento custa ação menor

═══════════════════════════════════════════════════════════════════
INCLINAÇÃO COMUNHÃO
═══════════════════════════════════════════════════════════════════

PARTILHA (grau 2, complexidade 3) — 34
Mover energia natural entre corpos. A especialização deste caminho governa a régua de volume transferível.
└─ Mão Cheia [ativado, ação padrão, contato]: cede 224 de REN por ato, e recebe pelo mesmo canal de quem colheu pelo praticante. LV5: 276, e alcance curto substitui o toque
└─ Sopro Comum [sustentado, 15 REN por turno]: mantém aliado no modo com a REN do praticante, sem que ele precise colher. LV5: dois aliados ao mesmo tempo

FUSÃO (grau 4, complexidade 4) — 42
Emprestar do parceiro a quietude que a própria cena nega.
└─ Colheita Emprestada [sustentado, ação padrão para firmar, parceiro do pacto presente]: o parceiro colhe enquanto o praticante se move e luta, à metade da taxa dele. A imobilidade continua valendo para o praticante sozinho. LV5: dois parceiros, e a taxa sobe a três quartos
└─ Voz de Dois [passivo, sem custo]: o parceiro fundido opera avisos e uma reação por turno sem consumir a ação do praticante. LV5: o parceiro executa uma técnica própria por turno

ENRAIZAMENTO (grau 3, complexidade 2) — 38
Conhecer a terra a ponto de ela devolver. A especialização deste caminho governa a régua de recuperação em terra viva.
└─ Chão Conhecido [passivo, sem custo]: 58 de REN por hora de repouso em terra sagrada, floresta antiga ou sítio de densidade viva, e o teto de saturação sobe um bloco enquanto o praticante estiver nela. LV5: 71 por hora, e a terra remove um grau de Petrificação a cada noite passada nela

═══════════════════════════════════════════════════════════════════
INCLINAÇÃO INVESTIDURA
═══════════════════════════════════════════════════════════════════

VIGOR (grau 1, complexidade 2) — 30
Converter energia natural em rendimento do corpo. A especialização deste caminho governa a régua de amplificação física.
└─ Corpo Saturado [passivo, sem custo]: reforço de 18 aos testes físicos contra os 9 de quem não possui o caminho, e o impacto sobe uma categoria contra estrutura e obra sem vida. LV5: 22

COURAÇA (grau 2, complexidade 3) — 34
Aguentar o que chegou. A especialização deste caminho governa a régua de absorção.
└─ Casca Viva [passivo, 10 REN por golpe recebido]: reduz 28 de dano por golpe, contra os 14 de quem não o possui. LV5: 34, e a redução vale contra dano de área sem custo adicional
└─ Osso que Não Cede [passivo, sem custo]: Ferimento Grave imposto ao praticante entra um grau abaixo enquanto o modo estiver de pé. LV5: dois graus abaixo, e o grau Leve não se instala

ENVOLTÓRIO (grau 3, complexidade 3) — 38
Atingir a partir da energia e não da pele. A especialização deste caminho governa a régua de alcance do envoltório.
└─ Alcance de Aura [passivo, sem custo]: o golpe parte do envoltório, a cinco metros do corpo. LV5: sete metros, e o envoltório intercepta quem entrar nele
└─ Varredura [ativado, ação padrão, 40 REN]: um único golpe alcança todos os alvos dentro do envoltório. LV5: dispensa a ação padrão uma vez por cena

PRONTIDÃO (grau 4, complexidade 2) — 42
Responder antes que o corpo comum responderia.
└─ Resposta Antecipada [passivo, sem custo]: uma reação adicional por turno enquanto o modo estiver de pé. O caminho responde e nunca informa, e o que o praticante percebe continua sendo pergunta de Sensoriamento. LV5: duas reações adicionais, e uma delas pode ser gasta por aliado em contato

═══════════════════════════════════════════════════════════════════
INCLINAÇÃO CONDUÇÃO
═══════════════════════════════════════════════════════════════════

AMPLITUDE (grau 2, complexidade 4) — 34
Elevar a obra que a energia atravessa.
└─ Obra Elevada [ativado, sem ação adicional, custo da técnica pago em REN]: a técnica executada sob o modo sobe uma categoria de escala, de alvo para área e de área para campo. LV5: duas categorias, e a REN passa a ter cano próprio de Limite de Saída
└─ Molde Sustentado [sustentado, 30 REN por turno]: a obra elevada permanece de pé sem consumir a ação do praticante. LV5: duas obras ao mesmo tempo

MORDENTE (grau 3, complexidade 4) — 38
Dar peso material ao que não tem corpo. A especialização deste caminho governa a régua de mordente.
└─ Carne no Que Não Tem [passivo, sem custo]: construto de chakra, entidade sem corpo e invocação de chakra puro deixam de ser inatingíveis, com o dano subindo uma categoria contra eles. LV5: a elevação alcança massa em escala de bijū
└─ Amarra Viva [ativado, ação padrão, 90 REN]: a energia natural adere ao alvo de chakra e impõe Imobilização, com o grau lido pela margem contra a oposição dele, persistindo enquanto o praticante sustentar. LV5: o alvo imobilizado sofre dreno da própria reserva por turno

O grau mede amplitude e determina o valor da especialização. A complexidade mede profundidade, governa quantos verbos o caminho concede e de que porte, e não entra em teste.
...
└─ Vaso Alargado LV6: teto de 2.060
└─ Fio de Água na Pedra LV6: 67 por turno em ambiente pobre, e nenhum lugar do mundo material é estéril
└─ Chama Baixa LV6: dreno no piso da régua, 5 por turno
└─ Corpo Interposto LV6: seis corpos, e a devolução dispensa o desfazimento do clone
...
└─ Sopro Comum LV6: todos os ligados ao mesmo tempo, sem contagem
└─ Colheita Emprestada LV6: quatro parceiros à taxa integral
...
└─ Casca Viva LV6: absorve 47 por golpe, valendo contra dano de área
└─ Osso que Não Cede LV6: os graus Leve e Moderado de Ferimento Grave não se instalam
└─ Alcance de Aura LV6: nove metros
└─ Varredura LV6: dispensa ação
...
└─ Molde Sustentado LV6: quatro obras simultâneas
└─ Carne no Que Não Tem LV6: duas categorias de elevação contra o incorpóreo
...
O sábio que não desliga constrói Ōgetsuhime sobre Sustento e Catalisador. Ele entra em cena com o modo erguido e não o perde, porque colhe em movimento mais rápido do que gasta parado, e vence o combate longo pela via da economia. A mesa dele administra terreno e ritmo em vez de acionamentos.

O punho da montanha constrói Takeminakata sobre Vigor e Envoltório. Ele resolve por corpo o que os outros resolvem por técnica, alcança nove metros sem tocar e atravessa estrutura pelo impacto elevado. É o arquétipo que a Fusão sustenta, porque alguém precisa colher enquanto ele luta.

O senhor do que não se vê constrói Ōkuninushi sobre Mordente. Ele existe para as ameaças que o resto da mesa não alcança, e é a única construção do sistema que prende uma entidade de chakra sem selo e sem barreira.
...
Estrutura e valores de camada leem o Núcleo de Perícias v2.2. Procedimento segue o Manual de Criação de Perícias v7.1. Custos leem o Manual de Economia de XP v2.2, seção 6.1. A régua de saturação consome o teste publicado na perícia de Controle de Chakra v3.2, e a condição Petrificação pertence ao Sistema de Efeitos de Status v2.2, que admite esta perícia como fonte de processo interno. A aceitação pelo chefe de espécie e os marcos de relação leem o Documento de Invocação, e a travessia até a terra lê a perícia de Passagem v1.1. O degrau de método que abre porta fechada lê o Manual Global de Treinamento. As técnicas nomeadas vivem no Compêndio de Senjutsu.
